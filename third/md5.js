...
define('md5', function(){
    ...
    var rv = {};
	rv.hex = function(s){return binl2hex(core_md5(str2binl(s),s.length*chrsz));};
	rv.b64 = function(s){return binl2b64(core_md5(str2binl(s),s.length*chrsz));};
	rv.str = function(s){return binl2str(core_md5(str2binl(s),s.length*chrsz));};

	rv.mac_hex = function(key,data){return binl2hex(core_hmac_md5(key,data));};
	rv.mac_b64 = function(key,data){return binl2b64(core_hmac_md5(key,data));};
	rv.mac_str = function(key,data){return binl2str(core_hmac_md5(key,data));};
	...
	rv.utf8_hex = function(s){return rv.hex(md5_Utf8Encode(s));};
	rv.utf8_b64 = function(s){return rv.b64(md5_Utf8Encode(s));};
	rv.utf8_str = function(s){return rv.str(md5_Utf8Encode(s));};
